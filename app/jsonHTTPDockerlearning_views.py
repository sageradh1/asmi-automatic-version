...
def upload():
    ...
    if request.method == 'POST':
        ...
        listOfResultsWithTuple,listOfResultsWithoutTuple,originalFrameArray,newframeArray,fps=extractFrameInfosFromVideo(startingdt_string+videofile.filename,getRightOptionAccordingToValue(selected_option))
